    ...
    public partial class initialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AwayTeamsId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PlayersId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AwayTeamPlayer", x => new { x.AwayTeamsId, x.PlayersId });
                    table.ForeignKey(
                        name: "FK_AwayTeamPlayer_Players_PlayersId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HomeTeamId = table.Column<Guid>(type: "uniqueidentifier", nullable: false, comment: "The indentifier of the home team"),
                    AwayTeamId = table.Column<Guid>(type: "uniqueidentifier", nullable: false, comment: "The indentifier of the away team"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Games_AwayTeams_AwayTeamId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    HomeTeamsId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PlayersId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_HomeTeamPlayer", x => new { x.HomeTeamsId, x.PlayersId });
                    table.ForeignKey(
                        name: "FK_HomeTeamPlayer_HomeTeams_HomeTeamsId",
                        column: x => x.HomeTeamsId,
                        principalTable: "HomeTeams",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HomeTeamPlayer_Players_PlayersId",
                        column: x => x.PlayersId,
                        principalTable: "Players",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AwayTeamPlayer_PlayersId",
                table: "AwayTeamPlayer",
                column: "PlayersId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HomeTeamPlayer_PlayersId",
                table: "HomeTeamPlayer",
                column: "PlayersId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_AwayTeamPlayer_AwayTeams_AwayTeamsId",
                table: "AwayTeamPlayer",
                column: "AwayTeamsId",
                principalTable: "AwayTeams",
                principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Games_HomeTeams_HomeTeamId",
                table: "Games",
                column: "HomeTeamId",
                principalTable: "HomeTeams",
                principalColumn: "Id",
