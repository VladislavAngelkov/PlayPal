...
namespace PlayPal.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        private PlayPalUser CreateUser()
        {
            try
            {
                return Activator.CreateInstance<PlayPalUser>();
            }
            catch
            {
                throw new InvalidOperationException($"Can't create an instance of '{nameof(PlayPalUser)}'. " +
                    $"Ensure that '{nameof(PlayPalUser)}' is not an abstract class and has a parameterless constructor, or alternatively " +
